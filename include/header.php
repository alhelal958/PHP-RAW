<?php
   ...
   $from_session_id =  $_SESSION['id'];
   $header_select = "SELECT * FROM users WHERE id = $from_session_id";
   $header_q = mysqli_query($db, $header_select);
   $header_assoc = mysqli_fetch_assoc($header_q);
  ...
  <body>
    ...
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
         <a href="Theme/index.php" target="_blank" class="sl-menu-link">
        ...
        <a href="users.php" class="sl-menu-link">
         ...
         <a href="socials.php" class="sl-menu-link">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon fa fa-comment tx-22"></i>
            <span class="menu-item-label">Socials</span>
          </div><!-- menu-item -->
         </a><!-- sl-menu-link -->       
          <a href="about.php" class="sl-menu-link">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon fa fa-info-circle tx-22"></i>
            <span class="menu-item-label">About</span>
          </div><!-- menu-item -->
         </a><!-- sl-menu-link -->       
          <a href="educations.php" class="sl-menu-link">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon fa fa-graduation-cap tx-22"></i>
        ...
        <a href="experience.php" class="sl-menu-link">
         ...
         <a href="testimonial.php" class="sl-menu-link">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon fa fa-quote-left tx-22"></i>
        ...
        <a href="contact.php" class="sl-menu-link">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon fa fa-road tx-22"></i>
          ...
          <div class="sl-menu-item">
            <i class="menu-item-icon icon fa fa-500px tx-22"></i>
            <span class="menu-item-label">Show Case</span>
          </div><!-- menu-item -->
         </a><!-- sl-menu-link --> 
          ...
          <div class="sl-menu-item">
            <i class="menu-item-icon icon fa fa-wrench tx-22"></i>
            <span class="menu-item-label">Services</span>
          </div><!-- menu-item -->
         </a><!-- sl-menu-link -->      

          <a href="hello_message.php" class="sl-menu-link">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon fa fa-address-card tx-22"></i>
            <span class="menu-item-label">Hello Message</span>
          </div><!-- menu-item -->
         </a><!-- sl-menu-link -->    
        ...
        <nav class="nav">
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              <span class="logged-name"><?= $_SESSION['name']; ?><span class="hidden-md-down"></span></span>
              <img src="upload/<?= $header_assoc['image'];?>" class="wd-32 rounded-circle" alt="">
            </a>
            <div class="dropdown-menu dropdown-menu-header wd-200">
              <ul class="list-unstyled user-profile-nav">
                <li><a href="edit-profile.php"><i class="icon ion-ios-person-outline"></i> Edit Profile</a></li>
                <li><a href="change-password.php"><i class="icon ion-ios-gear-outline"></i> Change Password</a></li>
