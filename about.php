<?php
  ...
  $selects = "SELECT COUNT(*) as total,id, summery FROM `about`";
    ...
    <div class="sl-page-title">    
     <div class="container">
      ...
      <?php if ($assoc['total'] == 0): ?>
        <a href="about-add.php"> <i class="fas fa fa-plus"></i>Add </a>
      <?php endif ?>
                      ...
                      <tr>
                        ...
                        <td>
                         <!--  <a class="btn btn-primary" href="hello-message-edit.php?id=<?= $value['id'];?>">Edit</a> -->
                           <a class="btn btn-danger" href="about-delete.php?id=<?= $value['id'];?>">Delete</a>
